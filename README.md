...
Анализ и статистика данных по школе 21. Процедуры и функции для получения информации, процедуры и триггеры для её изменения
...
Скрипт *part1.sql*, создающий базу данных и все таблицы, описанные выше. 
...
Скрипт *part2.sql*, в котором тестовые запросы/вызовы для каждого пункта:
...
Скрипт *part3.sql*, в котором описанные далее процедуры и функции 
...
##### 2) Функция, возвращая таблицу вида: ник пользователя, название проверенного задания, кол-во полученного XP
